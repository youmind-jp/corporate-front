    ...
    return (
        <section className="py-20 bg-darkmode" id="contact">
            <div className="container mx-auto lg:max-w-screen-xl px-4">
                <div className="bg-dark_grey bg-opacity-80 rounded-2xl p-10 shadow-lg w-full max-w-3xl mx-auto">
                    <h2 className="text-white text-30 font-bold mb-8 text-center">お問い合わせ</h2>
